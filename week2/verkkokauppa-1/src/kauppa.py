...
class Kauppa:
    def __init__(self, _varasto=varasto, _pankki=pankki, _viitegeneraattori=viitegeneraattori):
        self._varasto = _varasto
        self._pankki = _pankki
        self._viitegeneraattori = _viitegeneraattori
